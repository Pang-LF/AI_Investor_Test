        ...
        lines.extend(
            [
                (
                    ...
                    f"uncapped adjusted 20d="
                    f"{forecast.uncapped_expected_excess_return_20d:.2%}, "
                    f"bias-adjusted expected excess 5d="
                    f"{forecast.expected_excess_return_5d:.2%}, 20d="
                    f"{forecast.expected_excess_return_20d:.2%}, "
                    f"cap reason={forecast.forecast_cap_reason_20d or 'none'}, "
                    f"uncertainty_20d_decimal={forecast.uncertainty_20d:.6f}, "
